...
int main()
{
	...
	ps_init(fp, 0, 0, 3000, 2000);
	ps_setfont(fp, "Courier", 30);
	...
	ps_3d_draw_scene(fp, ps_3d_new_vector(1500, 600, -600), single_camera, ps_3d_new_vector(M_PI / 4, M_PI / 3, 0)); 
	...
	ps_3d_draw_scene(fp, ps_3d_new_vector(1500, 600, -600), isometric, ps_3d_new_vector(M_PI / 4, M_PI / 3, 0));
